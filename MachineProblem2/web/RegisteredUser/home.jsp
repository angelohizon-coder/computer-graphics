...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/MachineProblem2/RegisteredUser/style-home.css">
    </head>
    ...
    <body>        
        ...
        <% 
            ...
            if(session.getAttribute("loginTest") == null)
                response.sendRedirect("/MachineProblem2/Error/SessionDestroyed.jsp");
            else if(session.getAttribute("user") == null)
                response.sendRedirect("/MachineProblem2/index.jsp");
        %>
                            ...
                            <div class="row_one">
                                <div class="element">
                                    ...
                                    <a href="https://www.facebook.com/" target="_blank">
                                        <img src="/MachineProblem2/Images/Frame_1.png">
                                    </a>
                                </div>
                                <div class="element">
                                    <!-- GITHUB -->
                                    <a href="https://github.com/" target="_blank">
                                        <img src="/MachineProblem2/Images/Frame_2.png">
                                    </a>
                                </div>
                            </div>
                            <!-- BOTTOM ROW -->
                            <div class="row_two">
                                <div class="element">
                                    ...
                                    <a href="https://www.linkedin.com/" target="_blank">
                                        <img src="/MachineProblem2/Images/Frame_3.png">
                                    </a>
                                </div>
                                <div class="element">
                                <!-- INSTAGRAM -->
                                    <a href="https://www.instagram.com/" target="_blank">
                                        <img src="/MachineProblem2/Images/Frame_4.png">
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="about">
                            ...
                            <div class="about_image">
                                <a href="https://www.facebook.com/aewonsantos/" target="_blank">
                                    <img src="/MachineProblem2/Images/Picture_1.jpg" alt="Aaron"><br/>
                                </a>
                                <a href="https://www.facebook.com/anton.bondoc" target="_blank">
                                    <img src="/MachineProblem2/Images/Picture_2.jpg" alt="Anton"><br/>
                                </a>
                                <a href="https://www.facebook.com/xRusian/" target="_blank">
                                    <img src="/MachineProblem2/Images/Picture_3.jpg" alt="Angelo"><br/>
                                </a>
                            </div>
