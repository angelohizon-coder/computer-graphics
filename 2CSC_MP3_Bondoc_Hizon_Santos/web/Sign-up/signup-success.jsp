...
<html>
    <head>
        <title>Mismatch Exception</title>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/Sign-up/style-signup-success.css">
    </head>
    <body>
        <div class="main">          
            <div class="logo_bar">
            ...
            <div class="error_message">
                <div class="error">
                    ...
                    <a href="<%= request.getContextPath() %>/index.jsp">
                        <input class="btn" type="button" value="Return">
                    </a>
                </div>                
            </div>
