...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/Error/style-nullvalue-exception.css">
    </head>
    <body>
        <div class="main">          
            <div class="logo_bar">
            ...
            <div class="error_message">
                <div class="error">
                    <h1>
                        ...
                        <% 
                            String message = "username, password, and captcha were";
                            if((String)request.getAttribute("nullSignup") != null)
                                message = (String)request.getAttribute("nullSignup");
                        %>
                        It seems that <%= message %> not filled
                    </h1>
