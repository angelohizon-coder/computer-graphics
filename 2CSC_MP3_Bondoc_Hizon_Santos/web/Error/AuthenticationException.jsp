...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/Error/style-authentication-exception.css">
    </head>
    <body>
        <div class="main">          
            <div class="logo_bar">
            ...
            <div class="error_message">
                <div class="error">
                    <h1>
                        ...
                        <% 
                            String message = "username and password are";
                            if((String)request.getAttribute("authentication") != null)
                                message = (String)request.getAttribute("authentication");
                        %>
                        The entered <%= message %> incorrect
                    </h1>
