 ...
 * @author Angelo
 */
public class SelfPortraitVersionTwo extends Frame {
    ...
    public void background (Graphics g) {
        ...
        hsb = Color.RGBtoHSB(162,156,156, null);
    ...
    public void shirt(Graphics g){
        Graphics2D g2d = (Graphics2D) g;
        float[] hsb = new float[3];
        hsb = Color.RGBtoHSB(160,156,157, null);
        float hue, saturation, bright;
        hue = hsb[0];
        saturation = hsb[1];
        bright = hsb[2];
    ...
    public static void main(String[] args) {
        SelfPortraitVersionTwo i = new SelfPortraitVersionTwo();
